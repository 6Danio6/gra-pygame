...
def Levels():
    while True:
        ...
        BUTTON_1 = Button(image=pygame.image.load("buttons/square.png"), pos=(490, 300), 
                            text_input="1", font=settings.get_font(2,75), base_color="#d7fcd4", hovering_color="White")
        BUTTON_2 = Button(image=pygame.image.load("buttons/square.png"), pos=(640, 300), 
                            text_input="2", font=settings.get_font(2,75), base_color="#d7fcd4", hovering_color="White")
        BUTTON_3 = Button(image=pygame.image.load("buttons/square.png"), pos=(790, 300), 
                            text_input="3", font=settings.get_font(2,75), base_color="#d7fcd4", hovering_color="White")
        BUTTON_4 = Button(image=pygame.image.load("buttons/square.png"), pos=(490, 450), 
                            text_input="4", font=settings.get_font(2,75), base_color="#d7fcd4", hovering_color="White")
        BUTTON_5 = Button(image=pygame.image.load("buttons/square.png"), pos=(640, 450), 
                            text_input="5", font=settings.get_font(2,75), base_color="#d7fcd4", hovering_color="White")
        BUTTON_6 = Button(image=pygame.image.load("buttons/square.png"), pos=(790, 450), 
